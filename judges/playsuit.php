...
<body class="h-screen m-h-screen flex flex-col items-center justify-center">
    <div>
        <h5 class="font-[900] text-4xl tracking-wider text-gray-800">Jasper L. Tuazon</h5>
    </div>
    <div class="flex gap-12 mt-10 w-full">
        ...
        <div class="w-1/2 p-6 flex flex-col gap-3 px-12">
            <h1 class="text-center font-bold text-2xl bg-gray-300 py-2 rounded-md w-full text-gray-800 shadow-sm">PLAYSUIT</h1>
